...
namespace SampleRecogServerCSharp
{
    ...
    {
        //!!!IMPORTANT!!! set LD_LIBRARY_PATH in Linux 
        [DllImport("ImageClassifierDllWrapper.dll", EntryPoint = "Init")]
        static extern IntPtr Init();

        [DllImport("ImageClassifierDllWrapper.dll", EntryPoint = "Predict")]
        static extern void Predict(IntPtr handle, string imgFileName, StringBuilder predRes, int szPredRes);

        [DllImport("ImageClassifierDllWrapper.dll", EntryPoint = "Release")]
        ...
        public static bool InitializeRecognizer(VHubBackendStartParam pa)
        {
            ...
            if (!Object.ReferenceEquals(x, null))
            {
                ...
                /// <remarks>
                /// Call your own initilization function here.
                /// </remarks>
        ...
        public static RecogReply PredictionFunc(Guid id, int timeBudgetInMS, RecogRequest req)
        {
            ...
            Predict(classifierHandle, filename, sb, 256);
